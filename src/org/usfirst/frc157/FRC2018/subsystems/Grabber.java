...
public class Grabber extends Subsystem {
    ...
    private final WPI_TalonSRX rightMotor = RobotMap.intakeRightTalon;
    private final WPI_TalonSRX leftMotor = RobotMap.intakeLeftTalon;
    ...
    public void initDefaultCommand()
    {
        ...
        leftMotor.set(ControlMode.Follower, rightMotor.getDeviceID());
