  ...
  //private Lift.direction direction = Lift.direction.UP;
    ...
    protected void execute() {
        ...
        if (platFirst)
        {
            ...
            {
                Robot.lift.movePlat(Robot.lift.platPID.pidCalculate(posPlatFinal, Robot.lift.getPlatEncoder(), Lift.platPIDUp));
            }
            else
            {
                Robot.lift.stopPlat();
        ...
        else
        {
            ...
            {
                Robot.lift.movePlat(Robot.lift.platPID.pidCalculate(posPlatFinal, Robot.lift.getPlatEncoder(), Lift.platPIDDown));
            ...
            {
                Robot.lift.moveStage(-Robot.lift.stagePID.pidCalculate(posStageFinal, Robot.lift.getStageEncoder(), Lift.stagePIDDown));
            }
            else
            {
