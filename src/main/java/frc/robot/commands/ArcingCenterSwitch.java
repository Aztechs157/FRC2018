...
import frc.robot.commands.CenterSwitchAuton.autonState;
...
public class ArcingCenterSwitch extends Command
{
    ...
    public ArcingCenterSwitch(boolean left)
    {
        ...
        int target4 = (int)(Math.PI*Math.sqrt((Math.pow(90, 2)+Math.pow(40, 2))/2)/2);
        arc4 = new Ellipse(50, 150, -this.left, target4, this.left*-90, 3, 5);
