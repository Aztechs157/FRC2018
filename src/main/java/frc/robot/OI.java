...
import frc.robot.subsystems.Lift.direction;
    ...
    public OI() {
      ...
      /*  ControllerSwap = new JoystickButton(gamePad, 8);
        ...
        */
        ...
        opBack = new JoystickButton(operatorGamePad, 7);
        opStart = new JoystickButton(operatorGamePad, 8);
        ...
        lBumper.whileHeld(new grabberMove(false));
        rBumper = new JoystickButton(gamePad,6);
        rBumper.whileHeld(new grabberMove(true));
