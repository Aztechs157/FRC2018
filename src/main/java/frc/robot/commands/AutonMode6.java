...
public class AutonMode6 extends Command {
	...
	protected void execute() {
		...
		case driveArc1:
			...
			System.out.println("Platform Encoder: "+ Robot.lift.getPlatEncoder());
			System.out.println("Elevator Encoder: " + Robot.lift.getStageEncoder());
			System.out.println("Platform Power: " + platformPower);
