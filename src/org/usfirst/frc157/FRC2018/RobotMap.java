...
public class RobotMap {
    ...
    public static AnalogPotentiometer sideSelect;
    ...
    public static void init() {
        ...
        intakeRightTalon = new WPI_TalonSRX(4);
        
        
        intakeLeftTalon = new WPI_TalonSRX(3);
        autoSelect = new AnalogPotentiometer(2, 11.75, 0.0);
        sideSelect = new AnalogPotentiometer(3, 2.75, 0.0);
